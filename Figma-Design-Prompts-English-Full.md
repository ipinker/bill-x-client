# Fresh Accounting - Complete Figma Design Prompts (English)

**Version**: v2.0  
**Design Width**: 750px  
**Primary Color**: Deep Purple #7C4DFF  
**Design Style**: Clean, elegant, card-based, modern  
**Grid System**: 8rpx spacing grid
...
- **Primary Dark**: #5E35B1
- **Success**: #39B54A (Green)
- **Warning**: #F7C242 (Yellow)
- **Error**: #FC5872 (Coral Red)
- **Info**: #AE9AF0 (Purple)
...
### Typography
- **H1**: 48px (Page titles, large amounts)
- **H2**: 40px (Important numbers)
- **H3**: 36px (Section titles)
- **H4**: 32px (Navigation bar titles)
- **Body Large**: 28px (List items)
- **Body**: 26px (Regular text)
- **Body Small**: 24px (Secondary text)
- **Caption**: 22px (Hints)
...
- **Modal**: 0 12px 40px 0 rgba(0, 0, 0, 0.16)
- **Navigation**: 0 2px 10px 0 rgba(0, 0, 0, 0.05)
...
**Responsive Behavior**
- All horizontal margins should respect safe areas
- Maintain 30px side margins on standard screens
- Increase to 40px on larger screens (> 428px)
- All lists should have pull-to-refresh and infinite scroll
...
**Error States**
- Red border on invalid inputs (#FC5872)
- Error message: 22px, #FC5872
- Error icons: 24px
...
- Icon: 120px, #E5E5E5
- Message: 26px, #999999
- Action button: Optional based on context
...
**Touch Targets**
- Minimum size: 88px × 88px for primary actions
- Minimum size: 60px × 60px for secondary actions
...
- Navigation bar height: 44px + status bar
...
- Export mdpi, hdpi, xhdpi, xxhdpi, xxxhdpi for Android
- Use PNG for images with transparency
- Use WebP for optimized web delivery
- Icon format: SVG preferred, PNG fallback

**Color Palette Export**
- Provide as CSS variables
- Provide as JSON for native apps
- Include RGBA values for transparency

**Typography Export**
- Font files: OTF/TTF
- Web fonts: WOFF/WOFF2
- Size scale as design tokens

---

## Document Complete

This comprehensive Figma design prompt document covers all 30 pages with detailed specifications for building the Fresh Accounting app. Each page includes:
- Complete layout descriptions
...
Use this document as the single source of truth for implementing the design in Figma and subsequent development.